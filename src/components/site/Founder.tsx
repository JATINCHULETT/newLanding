...
export function Founder() {
  return (
    <section id="about-us" className="relative scroll-mt-24 overflow-hidden py-24 lg:py-32">
      <OrganicDecorations />
      <div
        aria-hidden
      ...
      <div className="shell grid items-center gap-14 lg:grid-cols-[0.85fr_1.15fr]">
        <Reveal>
          <div className="relative mx-auto w-full max-w-sm pb-6 sm:pb-0">
            <div
              aria-hidden
        ...
        <div>
          ...
          <Reveal delay={0.06}>
            <h2 className="mt-5 text-3xl font-extrabold leading-tight sm:text-4xl lg:text-[2.7rem]">
              ...
              <span className="block text-gradient">long before the crisis arrived.</span>
            </h2>
          </Reveal>
          <Reveal delay={0.12}>
            <div className="mt-6 space-y-4 text-base leading-relaxed text-muted-foreground">
              ...
              <p>
                So we built one. A practical, everyday system that helps schools spot what matters
                earlier, gives teachers language and confidence to respond, and teaches students the
                skills that make them steadier for life.
              </p>
            </div>
          </Reveal>
