...
export function AnimatedModalDemo() {
  const images = [
    "https://images.unsplash.com/photo-1517322048670-4fba75cbbb62?q=80&w=1000&auto=format&fit=crop",
    ...
    "https://images.unsplash.com/photo-1554931670-4ebfabf6e7a9?q=80&w=1000&auto=format&fit=crop",
    "https://images.unsplash.com/photo-1546484475-7f7bd55792da?q=80&w=1000&auto=format&fit=crop",
  ];

  return (
    <div className="py-20 flex items-center justify-center">
      <Modal>
        <ModalTrigger className="bg-black dark:bg-white dark:text-black text-white flex justify-center group/modal-btn px-6 py-3 rounded-full">
