...
import { ExpertFloatingBar } from "@/components/site/ExpertFloatingBar";
import { ExpertConsultationModal } from "@/components/site/ExpertConsultationModal";
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem("jaagr-theme");if(t==="dark"||(!t&&window.matchMedia("(prefers-color-scheme: dark)").matches)){document.documentElement.classList.add("dark");}}catch(e){}})();`,
          }}
        />
      </head>
      <body>
